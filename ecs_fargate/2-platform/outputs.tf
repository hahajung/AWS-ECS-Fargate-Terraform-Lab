...
output "ecs_public_subnets" {
  value = data.terraform_remote_state.infrastructure.outputs.ecs_public_subnets
}

output "ecs_private_subnets" {
  value = data.terraform_remote_state.infrastructure.outputs.ecs_private_subnets
}